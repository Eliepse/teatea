...
export function FormatOrigin(props: { origin: Partial<Pick<Origin, "namePath" | "name">>; maxLevel?: OriginLevel }) {
	const [country, region, locality] = props.origin.namePath ?? [props.origin.name].filter(v => v);
